...
module.exports = {
    ...
    SESSION: process.env.ACE_CODE === undefined ? '' : process.env.ACE_CODE,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖ANSHID💖' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+916238560742' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ?'ANSHID' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'COSMIC' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ COSMIC ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
